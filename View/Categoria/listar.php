                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Categoria</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php foreach ($categorias as $usuario) : ?>
                                                <tr>
                                                    <td><?php echo $usuario['ID'] ?></td>
                                                    <td><?php echo $usuario['NOME'] ?></td>
                                                    <td><a href="index.php?controller=CategoriaController&action=atualizar&id=<?php echo $usuario['ID'] ?>">Editar</a> - 
                                                        <a href="index.php?controller=CategoriaController&action=deletar&id=<?php echo $usuario['ID'] ?>">Deletar</a></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table>
