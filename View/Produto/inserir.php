                                    ...
                                    <form action="index.php?controller=ProdutoController&action=inserir" method="POST" class="form-horizontal">
                                        <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input class="input-xlarge focused" id="descricao" type="text" value="" name="descricao">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input class="input-xlarge focused" id="preco" type="text" value="" name="preco">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input class="input-xlarge focused" id="valor" type="text" value="" name="valor">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input class="input-xlarge focused" id="quantidade" type="text" value="" name="quantidade">
                                                </div>
                                            </div>
